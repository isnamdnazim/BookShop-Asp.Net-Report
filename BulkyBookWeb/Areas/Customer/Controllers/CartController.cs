    ...
    public class CartController : Controller
    {
        ...
        public IActionResult SummaryPOST()
        {
            ...
            foreach (var cart in ShoppingCartVM.ListCart)
            {
                ...
                //var product = _unitOfWork.Product.GetFirstOrDefault(t => t.Id == cart.ProductId);
		...
		public IActionResult Plus(int cartId)
		{
			...
			{
				TempData["ErrorMessage"] = $"There is {product.Quantity} product in stock!";
		...
		public IActionResult Minus(int cartId)
		{
			...
			if (cart.Count <= 1)
			{
				...
				_unitOfWork.Save();
				cart.Product.Quantity = product.Quantity;
				var count = _unitOfWork.ShoppingCart.GetAll(u => u.ApplicationUserId == userId).ToList().Count - 1;
